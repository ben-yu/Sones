...
namespace stk {
    ...
    class VolumeEnvelope : public Generator
    {
    public:
    ...
    inline StkFloat VolumeEnvelope :: tick( void )
    {
        if ( state_ ) {
    ...
    inline StkFrames& VolumeEnvelope :: tick( StkFrames& frames, unsigned int channel )
    {
